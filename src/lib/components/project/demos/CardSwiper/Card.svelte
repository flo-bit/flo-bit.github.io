...
<div
	class="w-full h-full absolute cursor-grab ease-in-out rounded-xl touch-none select-none {color}"
	bind:this={element}
>
	{#key image}
		{#if image}
	...
	<div class="p-4 absolute bottom-4 w-full flex justify-center text-white">
